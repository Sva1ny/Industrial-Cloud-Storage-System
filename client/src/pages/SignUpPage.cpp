    ...
    : QWidget(parent)
{
    ...
    // Subtitle
    auto *subtitle = new QLabel(QString::fromUtf8("\xe5\x88\x9b\xe5\xbb\xba\xe8\xb4\xa6\xe5\x8f\xb7"));
    ...
    m_confirmEdit->setPlaceholderText(QString::fromUtf8("\xe7\xa1\xae\xe8\xae\xa4\xe5\xaf\x86\xe7\xa0\x81"));
    ...
    // Submit
    m_submitBtn = new QPushButton(QString::fromUtf8("\xe6\xb3\xa8\xe5\x86\x8c"));
    ...
    auto *switchBtn = new QPushButton(QString::fromUtf8("\xe5\xb7\xb2\xe6\x9c\x89\xe8\xb4\xa6\xe5\x8f\xb7\xef\xbc\x9f  \xe7\x99\xbb\xe5\xbd\x95"));
    ...
    // Connections
    connect(m_submitBtn, &QPushButton::clicked, this, &SignUpPage::onSubmit);
    connect(switchBtn, &QPushButton::clicked, this, &SignUpPage::switchToSignIn);
}
...
void SignUpPage::onSubmit()
{
    ...
    if (password != confirm) {
        m_messageLabel->setText(QString::fromUtf8("\xe4\xb8\xa4\xe6\xac\xa1\xe5\xaf\x86\xe7\xa0\x81\xe4\xb8\x8d\xe4\xb8\x80\xe8\x87\xb4"));
        m_messageLabel->setProperty("state", "error");
        m_messageLabel->style()->unpolish(m_messageLabel);
        m_messageLabel->style()->polish(m_messageLabel);
        m_messageLabel->setVisible(true);
    ...
    m_messageLabel->setText(QString::fromUtf8("\xe6\xb3\xa8\xe5\x86\x8c\xe4\xb8\xad..."));
...
void SignUpPage::onSignUpSuccess()
{
    m_submitBtn->setEnabled(true);
    m_messageLabel->setText(QString::fromUtf8("\xe8\xb4\xa6\xe5\x8f\xb7\xe5\xb7\xb2\xe5\x88\x9b\xe5\xbb\xba\xef\xbc\x81\xe8\xaf\xb7\xe7\x99\xbb\xe5\xbd\x95"));
    m_messageLabel->setProperty("state", "success");
    m_messageLabel->style()->unpolish(m_messageLabel);
    m_messageLabel->style()->polish(m_messageLabel);
    m_messageLabel->setVisible(true);
...
void SignUpPage::onSignUpFailed(const QString &error)
{
    m_submitBtn->setEnabled(true);
    m_messageLabel->setText(QString::fromUtf8("\xe6\xb3\xa8\xe5\x86\x8c\xe5\xa4\xb1\xe8\xb4\xa5: ") + error);
    m_messageLabel->setProperty("state", "error");
    m_messageLabel->style()->unpolish(m_messageLabel);
    m_messageLabel->style()->polish(m_messageLabel);
    m_messageLabel->setVisible(true);
